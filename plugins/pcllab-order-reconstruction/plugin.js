...
jsPsych.plugins["pcllab-order-reconstruction"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    // Shuffle the array.
    var reorderedList = shuffle(trial.ordered_list);
    ...
    for(var i = 1; i <= trial.ordered_list.length; i++) {
      var container = $('<div>',{
    ...
    display_element.append($('<h3 style="text-align: center; padding-bottom: 15px;">Order Reconstruction</h3>'));
    ...
    function end_trial() {
      var time = firstInteractionTime = (new Date()).getTime() - startTime;
      ...
      var trial_data = {
        ...
        "history": history,
        "distanceList": get_distance_list(trial.ordered_list, userOrderedList)
      };
